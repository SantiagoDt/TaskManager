...
>  
> [!NOTE]  
> **Implementado**: Autenticación completa mediante `Authorization: Bearer <token>` en tasks-svc
---
...
> [!IMPORTANT]  
> **JWT_SECRET**: Debe ser el mismo en ambos servicios y tener al menos 32 caracteres para HS256.  
